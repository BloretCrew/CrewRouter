...
assert.deepStrictEqual(scanHtml('<script>"<button>"; "loading error"; "<table>";</script><style>.x::before{content:"<button> loading error <table>"}</style><button class="modal-close">Close</button><div class="modal">Modal</div>'), { controls: 1, nativeDialogs: 0, forms: 0, tables: 0, states: 0, legacyModalContainers: 1 });
