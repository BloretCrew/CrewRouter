import { l as p, h as l } from "./icons-registry-BEZgQ6x-.js";
const g = {
  "arrow-down": [
...
function i(a, r, s) {
  const t = a.createElementNS(e, r);
  for (const [c, h] of Object.entries(s)) t.setAttribute(c, h);
  return t;
}
function M(a, r = 16, s = document) {
  const t = s.createElementNS(e, "svg");
  t.setAttribute("width", String(r)), t.setAttribute("height", String(r)), t.setAttribute("viewBox", "0 0 24 24"), t.setAttribute("fill", "none"), t.setAttribute("stroke", "currentColor"), t.setAttribute("stroke-width", "2"), t.setAttribute("stroke-linecap", "round"), t.setAttribute("stroke-linejoin", "round"), t.setAttribute("aria-hidden", "true"), t.setAttribute("data-blora-icon", a);
  const c = g[a] ?? p(a);
  if (c)
    for (const h of c) {
      const d = i(s, h.tag, h.attrs);
      t.appendChild(d);
    }
  return t;
}
function n(a) {
  return Object.prototype.hasOwnProperty.call(g, a) || l(a);
}
export {
  M as c,
  n as i
